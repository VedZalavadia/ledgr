...
export default function ExpenseForm({ onAdd, onDone, expenses = [] }) {
  ...
  useEffect(() => {
    if (itemName.trim().length === 0) { setSuggestions([]); return; }
  ...
  const handleSubmit = () => {
    ...
    setForm({ title: "", category: "Groceries", date: todayStr(), notes: "" });
    setItems([]);
    onDone();
  };
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 520 }}>
        ...
        <div style={{
          background: "#fff", border: "0.5px solid #e8e6e0", borderRadius: 16,
              ...
              <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
                <div style={{ flex: 2, position: "relative" }}>
                  ...
                  {showSuggestions && suggestions.length > 0 && (
                    <div style={{
                      ...
                      background: "#fff", border: "0.5px solid #e8e6e0", borderRadius: 10,
                      zIndex: 100, overflow: "hidden", boxShadow: "0 4px 16px rgba(0,0,0,0.06)",
                    }}>
                      {suggestions.map((s, i) => (
                        <div
                          key={s}
                          ...
                          style={{
                            ...
                            background: "#fff", transition: "background 0.1s ease",
                          }}
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 10, padding: "0 16px", fontSize: 18,
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                {items.map((item, i) => (
                  <div key={i} style={{
                    ...
                    background: "#faf9f7", border: "0.5px solid #e8e6e0", borderRadius: 8, padding: "8px 12px",
                  }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      ...
                      <button
                        ...
                        style={{ background: "none", border: "none", cursor: "pointer", color: "#ccc", fontSize: 16, lineHeight: 1, padding: 0, transition: "color 0.15s ease" }}
                ...
                <div style={{ display: "flex", justifyContent: "space-between", padding: "10px 12px 0", borderTop: "0.5px solid #f0ede8", marginTop: 4 }}>
